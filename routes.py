   ...
   if form.is_submitted():
      ...
      try:
         ...
         if money > balance.amount:
            win32api.MessageBox(0, 'You do not have enough money in your bank account to make this purchase', 'Alert', 0x00001000)
            ...
            h1 = customer_db.Holdings(name = company_name, value=money,gain=money_gain)
            session.add(h1)
